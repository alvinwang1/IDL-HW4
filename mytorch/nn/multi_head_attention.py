...
class MultiHeadAttention:
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        ...
        key_mask = key_padding_mask.reshape(self.N, 1, 1, self.S) if key_padding_mask is not None else None
        attention_mask = attn_mask.reshape(1, 1, self.L, self.S) if attn_mask is not None else None
        ...
        return np.broadcast_to(combined, (self.N, self.num_heads, self.L, self.S))
